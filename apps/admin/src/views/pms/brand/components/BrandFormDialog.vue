  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="品牌首字母：" prop="firstLetter">
        <el-input v-model="form.firstLetter" class="form-input" maxlength="1" />
      </el-form-item>
...
const defaultForm: Partial<BrandVo> = {
  id: undefined,
  name: '',
  firstLetter: '',
  sort: 0,
...
const form = reactive<Partial<BrandVo>>({ ...defaultForm });
...
const handleSubmit = async () => {
  ...
  try {
    if (props.isEdit) {
      await brandStore.update(form.id!, form as any);
      ElMessage.success('修改成功');
    } else {
      await brandStore.create(form as any);
